...
This is a port of https://github.com/rxi/sj.h/blob/master/sj.h with some "fixes" to improve correctness, alongside some added "epic oop inheritance design pattern" to allow reading from data implemented through by extending [`SJReader`](SJReader.cs) and [`SJWriter`](SJWriter.cs).
...
### Reader
Use the [`SJStringReader`](SJStringReader.cs) class to get started.
...
### Writer
Use the [`SJStringWriter`](SJStringWriter.cs) class to get started.
...
More examples are in the [`./Examples`](./Examples) directory. <br>
