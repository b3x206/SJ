...
4. Development is mainly done in the `devel` branch.
...
<strong>In fact, you should read most documents like this.</strong>
</summary>
...
* Can parse large valid JSON documents and "jsonc" (Comments not captured).
